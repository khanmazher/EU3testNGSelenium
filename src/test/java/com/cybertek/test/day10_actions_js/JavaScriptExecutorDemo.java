...
public class JavaScriptExecutorDemo {
    ...
    public void clickWithJS(){
        driver.get("http://practice.cybertelschool.com/");
        WebElement drodownLink = driver.findElement(By.linkText("Dropdown"));
        JavascriptExecutor jse = (JavascriptExecutor) driver;

        jse.executeScript("arguments[0].click", drodownLink);
    }
